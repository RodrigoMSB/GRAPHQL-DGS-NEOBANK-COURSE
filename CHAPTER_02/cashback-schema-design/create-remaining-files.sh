...
cat > src/main/java/com/neobank/cashback/service/CashbackService.java << 'EOF'
...
# Application main
mkdir -p src/main/java/com/neobank/cashback
cat > src/main/java/com/neobank/cashback/CashbackRewardsApplication.java << 'EOF'
...
spring.application.name=cashback-rewards-graphql
server.port=8080
...
echo "Archivos restantes creados"
